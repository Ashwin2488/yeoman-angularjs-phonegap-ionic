...
function jqmLiEntryDirective(isDivider) {
  return function() {
    return {
      ...
      scope: {},
      template: isDivider ?
        '<li jqm-scope-as="jqmLi"  class="ui-li ui-li-divider ui-bar-{{$theme}}"  jqm-class="{\'ui-first-child\': $position.first, \'ui-last-child\': $position.last}"  ng-transclude></li>' :
        '<li jqm-scope-as="jqmLi"  class="ui-li ui-li-static ui-btn-up-{{$theme}}"  jqm-class="{\'ui-first-child\': $position.first, \'ui-last-child\': $position.last}"  ng-transclude></li>'
    };
  };
}
